...
def download_audio(url, output_folder):
    ...
    try:
        ...
        with requests.Session() as session:
            ...
            response = session.get(url, timeout=60, stream=True, headers=headers, allow_redirects=True, verify=False)
...
def analyze_transcript_with_llm(transcript, audio_filename):
    ...
    try:
        ...
        cutoff_date_str = "April 24, 1950" # Default fallback
...
{transcript}
--- TRANSCRIPT END ---
# Telesales Mastermind Evaluation and Optimization

## Context:
You are a **telesales mastermind**, renowned for transforming telesales teams into high-performing, money-making machines. Your expertise lies in identifying weaknesses, amplifying strengths, and developing highly effective sales scripts and strategies that close deals consistently. 

Our sales team consists of **licensed insurance agents** who sell **live transfer leads** and **digital leads** to other insurance agents. This is part of what we call our **agent-to-agent campaign**. The goal is to maximize the performance of our outbound sales calls and dramatically improve conversion rates.

You can reference our landing page for additional context: [www.getlifeassurance.com](https://www.getlifeassurance.com).

---

## Your Task:
Your task is to **review our outbound calling transcripts** and provide a detailed analysis of how to improve our sales team's performance. Specifically, we need you to:

1. **Identify Strengths**:
   - Highlight what the sales agents are doing well.
   - Provide examples of techniques or phrasing that build trust, rapport, or effectively overcome objections.

2. **Pinpoint Weak Areas**:
   - Identify specific areas where sales agents are struggling or losing the interest of prospects.
   - Point out any ineffective phrases, poor transitions, or missed opportunities in the sales process.

3. **Provide Actionable Recommendations**:
   - Suggest specific improvements to phrasing, delivery, tone, and timing.
   - Provide **specific examples of what to say** in response to common objections (e.g., "I’m not interested," "It’s too expensive," "I already have a lead vendor").
   - Outline ways to make conversations more engaging, persuasive, and results-driven.
   - Suggest ways to refine call openings, transitions, and closings.

4. **Create a Winning Playbook**:
   - Develop or refine a sales script that incorporates your recommendations.
   - Include strategies for building rapport quickly, qualifying prospects effectively, and closing deals confidently.
   - Suggest psychological techniques or sales tactics that will make our agents “mastermind closers.”

---

## Areas of Focus:
Below are areas where we need your detailed feedback and recommendations:

### 1. **Call Openings**
   - Are the openings engaging and professional?
   - How can agents immediately capture the attention of prospects?
   - Provide examples of strong opening lines that build credibility and pique interest.

### 2. **Rapport Building**
   - Are agents effectively building rapport and trust with prospects?
   - Suggest ways to make conversations feel more natural and personalized.
   - Provide examples of rapport-building phrases or questions.

### 3. **Qualifying Questions**
   - Are agents asking the **right questions** to qualify prospects effectively?
   - Suggest specific qualifying questions that help uncover the prospect's pain points, needs, and goals.

### 4. **Overcoming Objections**
   - How well are agents handling common objections (e.g., price concerns, skepticism, lack of interest)?
   - Provide **specific rebuttals** or response templates for the most common objections.

### 5. **Closing the Deal**
   - Are agents confidently transitioning to the close?
   - Suggest closing techniques or phrasing that solidify the sale and create urgency.
   - Provide examples of strong closing statements that leave no room for hesitation.

### 6. **Tone and Delivery**
   - Is the tone of the agents’ delivery confident, friendly, and professional?
   - Suggest ways to improve voice inflection, pacing, and overall delivery.

---

## Deliverables:
Provide a detailed response that includes the following:

1. **Strengths Analysis**:
   - Highlight specific phrases, techniques, or strategies that are working well.
   - Explain why these elements are effective and how they contribute to successful outcomes.

2. **Weaknesses Analysis**:
   - Identify specific areas where agents are underperforming or where improvements are needed.
   - Provide direct examples or patterns observed in transcripts that demonstrate these weaknesses.

3. **Actionable Recommendations**:
   - Include **specific examples of what to say** in different parts of the call (openings, objections, closing, etc.).
   - Develop sample scripts, rebuttals, and playbooks that agents can start using immediately.

4. **Psychological Techniques**:
   - Suggest proven psychological sales strategies (e.g., reciprocity, social proof, urgency) that can be incorporated into calls.
   - Explain how these techniques can increase trust and conversion rates.

5. **Sales Script Playbook**:
   - Provide a refined and optimized sales script for the agent-to-agent campaign.
   - Include sections for call openings, rapport building, qualifying questions, objection handling, and closing.

---

## Additional Resources:
For context, visit our landing page: [www.getlifeassurance.com](https://www.getlifeassurance.com). Use this page to better understand our product offerings, value proposition, and key selling points.

---

## Desired Outcome:
At the end of this analysis, we expect to receive a comprehensive breakdown of how to transform our sales team into **mastermind closers**. Your insights should:
- Dramatically improve our outbound calling performance.
- Equip our agents with the tools and scripts to handle any situation confidently.
- Increase our **conversion rates** and overall sales success.
"""
        messages = [
