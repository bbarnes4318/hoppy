...
Analyze the provided transcription to determine if any applications were submitted for the following insurance plans:

ACA Health Insurance:

Indicator: The customer provides their social security number.
Question: Did the customer provide their social security number?
Response Example: Yes / No
Dental/Vision Insurance:

Indicator: The customer provides a bank account and routing number or a debit/credit card to the agent.
Question: Did the customer provide a bank account and routing number or a debit/credit card to the agent?
Response Example: Yes / No
If Yes, capture the premium amount.
Premium Amount Question: What is the premium amount mentioned?
Response Example: $[amount]/month
...
After analyzing the transcription, provide the summary in the following format:

Were any applications submitted?

Response: Yes / No
For each type of insurance:
a. ACA Health Insurance: Yes / No
b. Dental/Vision Insurance: Yes / No
i. Premium amount: $[amount]/month
c. Disability Insurance: Yes / No
i. Premium amount: $[amount]/month
d. Life Insurance: Yes / No
i. Premium amount: $[amount]/month
