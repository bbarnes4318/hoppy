...
Call Analysis: Billable Call Criteria

Is the call billable?
Answer: __________
...
Was an application submitted for dental or vision insurance?
Answer: __________

Criteria for a Billable Call:

The call is considered billable unless ANY of the following conditions are TRUE:

The caller is aged 65 or older.
Answer: __________
The caller has Medicare, Medicaid, TRICARE, or VA coverage.
Answer: __________
The caller's annual income exceeds $22,000.
Answer: __________
The caller did not confirm their intent to set up new insurance coverage through the marketplace today. (Must be YES)
Answer: __________
The caller is on the call solely for customer service, monthly cash assistance, or food cards.
Answer: __________
The caller is seeking subsidy cards or benefits cards.
Answer: __________
The caller is not aware that the call is to discuss ACA health insurance.
Answer: __________
    """
