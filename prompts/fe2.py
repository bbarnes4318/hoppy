...
Criteria for a Non-Billable Call (Must meet one or more):
    1. Unqualified Customer:
        - Age 75+ (Born on or before {cutoff_date_str}).
    ...
    4. Unanswered Call
	- Licensed agent does not answer the phone call
...
Criteria for Final Expense Application Submitted:
...
4. Call Summary:
    - Provide a one paragraph summary of the call
