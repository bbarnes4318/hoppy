...
Purpose: Evaluate the name of the company that answers the live transfer phone call

Process Overview:
1.Please identify the name of the company who answers the live transfer phone call. This transfer occurs in the later half of the phone call. Please give detailed notes on who this company might be. 
    """
