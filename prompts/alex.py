...
Your Objectives: Answer the question below about the phone call: 
    ...
    1. Was the call answered by a human or an answering machine? 	
	a. human
	b. answering machine

    If human:
    2. Was the prospect interested?
        a. Yes
	b. No     
   
    3. If No, why not and what was the outcome? 

    4. If Yes, what was the outcome? 
