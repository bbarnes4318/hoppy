...
Your Objectives: Answer the question below about the phone call: 
    ...
    1. Does the prospect reside in a nursing home or assisted living facility?	

    2. Does the prospect need a power of attorney when making financial decisions?
        
    3. Does the prospect have an active bank account? 

    4. Does the prospect have time to speak with a licensed agent regarding their final expense insurance?
"""
        messages = [
