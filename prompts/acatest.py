...
def analyze_transcript_with_chatgpt(transcript):
    ...
    1. Whether the call is billable. A call is NOT billable if:
       ...
       - The prospect has Medicare, Medicaid, or Tricare health insurance.
    ...
    5. Did the customer apply for ACA health insurance? A key indicator of an application being submitted is when the customer provides their social security number.
    """
