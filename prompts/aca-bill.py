...
# ACA Health Insurance Call Billability Analysis

## Primary Task
Analyze call transcripts to determine: 1.) if the call is billable based on strict eligibility criteria and 2.) if an enrollment for ACA Health Insurance occured during the call
...
2. **Existing Coverage**
   ...
   - Has Tricare
   - Has VA coverage
   - Has employer-provided coverage
...
4. **Call Quality Issues**
   ...
   - Prank or vulgar calls
   - Only requesting Do Not Call List placement
   - Customer doesn't know why they're on the call

5. **Plan Status**
   - Already renewed their 2025 ACA Marketplace Health Insurance plan
   (Note: Having current ACA coverage without 2025 renewal is acceptable)

## ACA Health Insurance Enrollments

### For New Enrollments & 2025 Renewals
Must have ONE of:
- Last 4 digits of SSN
- First 5 digits of SSN
- Full 9-digit SSN
- Confirmation of application submission with dates/reference numbers

### For AOR Changes
Must have:
- Third-party verification on phone call OR OTP code verification
- Customer must be on the call with third party long enough for the third party to confirm customer's name

## Analysis Output Format

1. **Billability Determination**
   - Billable: [Yes/No]
...
3. **Enrollments**
   - Sale Type: [New Enrollment/AOR Change/2025 Renewal]
   - Verification Method: [SSN/Third-party/OTP]
...
-Sale: Yes (Yes or No)
- Sale Type: Attempted New Enrollment
- Verification Method: SSN last 4
