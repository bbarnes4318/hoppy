...
def analyze_transcript_with_chatgpt(transcript):
    ...
    3. Carrier Selected
    4. Monthly Premium
    5. List any health issues and/or medications
    6. Bank Routing Number
    7. Bank Account or Credit Card Number and expiration date
    8. Payment Date each month
    8. Social Security Number
    9. The prospect's phone number
    """
