...
def analyze_transcript_with_chatgpt(transcript):
    ...
    Based on the transcript, provide the following details:

    For a customer who purchased a policy:
    1. Is the call billable? (Yes/No)
    2. Did the customer purchase a final expense policy? (Yes/No)
       a. If Yes, what is the monthly premium?
       b. If Yes, which carrier?
       c. If Yes, what coverage amount was agreed to?
    3. Policy sold (Yes/No)

    For a customer who did NOT purchase a policy:
    1. Is the call billable? (Yes/No). If No, specify why.
    2. Did the customer purchase a final expense policy? (Yes/No)
    3. If No policy purchased:
       a. Coverage Quoted
       b. Premium Quoted
       c. Carrier Quoted
       d. Was a follow-up set? (Yes/No, specify when if Yes)
    """
