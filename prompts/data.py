...
def analyze_transcript_with_chatgpt(transcript):
    ...
    2. Whether a sale was made, and if so, include the insurance carrier and monthly premium.
    3. The prospect's social security number
    4. The prospect's drivers license number
    """
