...
def analyze_transcript_with_chatgpt(transcript):
    ...
    2. Whether the call is billable. A call is not billable if:
       ...
       - The prospect is unaware they are on the call to speak with an agent regarding ACA Health Insurance.
       - The prospect is only on the call to waste the agent’s time or it's a prank call.
    4. Whether a sale was made, and if so, include the insurance carrier and monthly premium.
    5. The prospect's phone number
    """
