...
1. **Final Expense Application Determination:** Identify if an application for final expense insurance was submitted during the call.  
   ...
   - If an application was submitted, provide:
     - a. Monthly premium.
     - b. Insurance Carrier.
     - c. Coverage Amount.
     ...
     - e. Was coverage declined by the carrier? 
    """
