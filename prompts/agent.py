...
I noticed that one of our licensed agents has been experiencing very short call duration times when answering live transfer calls from our call centers. I need help determining if this is our call centers fault for not properly qualifying the calls or if it's our agents fault for not engaging the customers on the calls. 

Every other call, starting with the first call, is our licensed agent. Every other call, starting with the second call, is our call center speaking to the same prospect prior to transferring to our agent. 

Please determine on each call who's fault it is that the call only lasts a couple of minutes. In addition, please offer your insights on how the call center and how our licensed agent can improve. 
    """
