...
def analyze_transcript_with_chatgpt(transcript):
    ...
    2. Customer's social security number
    3. Customer's bank routing number
    4. Customer's bank account number
    5. Customer's credit card number
    6. Customer's credit card expiration date and 3 digit CVV code
    7. The Name of Carrier
    8. The monthly premium
    9. The day of the month payment will come out on
    10. Customer's height
    11. Customer's weight
    12. Customers drivers license number
    13. Customer's beneficary and their relationship to customer
    """
