...
def analyze_transcript_with_llm(transcript):
    ...
    """
    prompt = f"""
Analyze the following call transcript and provide a detailed response based on the instructions below:
### Transcript:
{transcript}
...
1. **Billable Call Determination**:
   - Determine if the call is billable based on the following criteria. Do not consider sales outcomes when determining billability.
...
{
  "billable": "Yes/No",
  "billable_reason": "Reason if not billable",
  "sale": "Yes/No",
  "sale_type": "New Enrollment/Renewal/AOR Change/No Sale",
  "sale_reason": "Reason if no sale",
  "supporting_information": {
    "prior_enrollments": "Details",
  ...
  "abrupt_ending": {
    "ended_abruptly": "Yes/No",
    "reason": "Explanation",
    "last_thing_said": "Content"
  }
}
    """
    try:
